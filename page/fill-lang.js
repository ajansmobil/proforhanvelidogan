...
const shortTranslations = {
  ...
  'ebvuntqzxn': {
    ...
    description: { en: 'Prof. Orhan Veli Doğan: supervised master\'s theses, peer review for Turkish Journal of Thoracic and Cardiovascular Surgery and Journal of Vascular Surgery, national and international congress session chair, endovascular courses.', de: 'Prof. Dr. Orhan Veli Doğan: Betreute Masterarbeiten, Gutachten für türkische Zeitschriften für Thorax- und Gefäßchirurgie, nationale und internationale Kongress-Sitzungsleitung, endovaskuläre Kurse.', ru: 'Проф. д-р Орхан Вели Доган: руководство магистерскими диссертациями, рецензирование в турецких журналах торакальной и сосудистой хирургии, председатель секций национальных и международных конгрессов, курсы по эндоваскулярным вмешательствам.' },
    ...
    spot: { en: 'Master\'s theses, journal and congress peer review, national/international scientific activities. Prof. Orhan Veli Doğan academic activities.', de: 'Masterarbeiten, Zeitschriften- und Kongress-Gutachten, nationale/internationale wissenschaftliche Aktivitäten. Prof. Dr. Orhan Veli Doğan akademische Tätigkeiten.', ru: 'Магистерские диссертации, рецензирование журналов и конгрессов, национальная/международная научная деятельность. Проф. д-р Орхан Вели Доган академическая деятельность.' }
  },
  'xnzu5au0ag': {
    name: { en: 'Contact', de: 'Kontakt', ru: 'Контакты' },
    description: { en: 'Prof. Orhan Veli Doğan – Cardiovascular Surgery. Appointment and contact information. Director of Cardiovascular Surgery at Defne and Akademi Hospital.', de: 'Prof. Dr. Orhan Veli Doğan – Herz- und Gefäßchirurgie. Termin und Kontakt. KVC-Direktor Defne und Akademi Krankenhaus.', ru: 'Проф. д-р Орхан Вели Доган – сердечно-сосудистая хирургия. Запись на приём и контакты. Директор КВХ в больницах Defne и Akademi.' },
    ...
    spot: { en: 'Appointment and contact. Get in touch with cardiovascular surgery specialist Prof. Orhan Veli Doğan.', de: 'Termin und Kontakt. Kontakt mit Herz-Gefäßchirurg Prof. Dr. Orhan Veli Doğan.', ru: 'Запись и контакты. Свяжитесь со специалистом по сердечно-сосудистой хирургии проф. д-ром Орханом Вели Доганом.' }
  },
  'yvi9dlb59o': {
    name: { en: 'Curriculum Vitae', de: 'Lebenslauf', ru: 'Резюме' },
    description: { en: 'Prof. Orhan Veli Doğan, Cardiovascular Surgery. Hacettepe Medical School, Dışkapı Training Hospital, Mustafa Kemal University. Director of Cardiovascular Surgery at Defne and Akademi Hospital.', de: 'Prof. Dr. Orhan Veli Doğan, Herz- und Gefäßchirurgie. Hacettepe Medizin, Dışkapı Ausbildungskrankenhaus, Mustafa Kemal Universität. KVC-Direktor Defne und Akademi Krankenhaus.', ru: 'Проф. д-р Орхан Вели Доган, сердечно-сосудистая хирургия. Медфак Хаджеттепе, учебная больница Дышкапы, университет Мустафы Кемаля. Директор КВХ в больницах Defne и Akademi.' },
    keyword: { en: 'Orhan Veli Doğan CV, cardiovascular surgery, Professor, Hacettepe, Mustafa Kemal University', de: 'Orhan Veli Doğan Lebenslauf, Herz-Gefäßchirurgie, Professor, Hacettepe, Mustafa Kemal Universität', ru: 'Орхан Вели Доган резюме, сердечно-сосудистая хирургия, профессор, Хаджеттепе, университет Мустафы Кемаля' },
    spot: { en: 'Prof. Orhan Veli Doğan – Cardiovascular surgery specialist. Hacettepe and Mustafa Kemal University. Clinical chief and director of cardiovascular surgery.', de: 'Prof. Dr. Orhan Veli Doğan – Facharzt Herz-Gefäßchirurgie. Hacettepe und Mustafa Kemal Universität. Klinikchef und KVC-Direktor.', ru: 'Проф. д-р Орхан Вели Доган – специалист по сердечно-сосудистой хирургии. Хаджеттепе и университет Мустафы Кемаля. Руководитель клиники и директор КВХ.' }
  },
  'hakkimizda': {
    name: { en: 'Curriculum Vitae', de: 'Lebenslauf', ru: 'Резюме' },
    description: { en: 'Prof. Orhan Veli Doğan, Cardiovascular Surgery. Hacettepe, Dışkapı Training Hospital, Mustafa Kemal University. Director of Cardiovascular Surgery at Defne and Akademi Hospital.', de: 'Prof. Dr. Orhan Veli Doğan, Herz- und Gefäßchirurgie. Hacettepe, Dışkapı Ausbildungskrankenhaus, Mustafa Kemal Universität. KVC-Direktor Defne und Akademi Krankenhaus.', ru: 'Проф. д-р Орхан Вели Доган, сердечно-сосудистая хирургия. Хаджеттепе, учебная больница Дышкапы, университет Мустафы Кемаля. Директор КВХ в больницах Defne и Akademi.' },
    keyword: { en: 'Orhan Veli Doğan CV, cardiovascular surgery, Professor, Hacettepe, Mustafa Kemal University', de: 'Orhan Veli Doğan Lebenslauf, Herz-Gefäßchirurgie, Professor, Hacettepe, Mustafa Kemal Universität', ru: 'Орхан Вели Доган резюме, сердечно-сосудистая хирургия, профессор, Хаджеттепе, университет Мустафы Кемаля' },
    spot: { en: 'Prof. Orhan Veli Doğan – Cardiovascular surgery specialist. Hacettepe and Mustafa Kemal University. Clinical chief and KVC director.', de: 'Prof. Dr. Orhan Veli Doğan – Facharzt Herz-Gefäßchirurgie. Hacettepe und Mustafa Kemal Universität. Klinikchef und KVC-Direktor.', ru: 'Проф. д-р Орхан Вели Доган – специалист по сердечно-сосудистой хирургии. Хаджеттепе и университет Мустафы Кемаля. Руководитель клиники и директор КВХ.' }
  },
  'misyon': {
    name: { en: 'Mission', de: 'Mission', ru: 'Миссия' },
    description: { en: 'Prof. Orhan Veli Doğan and team: patient-centred, evidence-based and reliable cardiovascular surgery care.', de: 'Prof. Dr. Orhan Veli Doğan und Team: patientenorientierte, evidenzbasierte und zuverlässige Herz-Gefäßchirurgie.', ru: 'Проф. д-р Орхан Вели Доган и команда: пациентоориентированная, доказательная и надёжная помощь в области сердечно-сосудистой хирургии.' },
  ...
  'kalitepolitikamiz': {
    ...
    description: { en: 'Our quality policy: patient safety, continuous improvement and compliance with cardiovascular surgery standards. Prof. Orhan Veli Doğan clinic.', de: 'Unsere Qualitätspolitik: Patientensicherheit, kontinuierliche Verbesserung, Standards der Herz-Gefäßchirurgie. Prof. Dr. Orhan Veli Doğan Klinik.', ru: 'Наша политика качества: безопасность пациентов, постоянное улучшение и соответствие стандартам сердечно-сосудистой хирургии. Клиника проф. д-ра Орхана Вели Догана.' },
  ...
  'kisiselveriler': {
    ...
    description: { en: 'Processing of personal data, data controller information and data security under Turkish PDPA. Prof. Orhan Veli Doğan website.', de: 'Verarbeitung personenbezogener Daten, Verantwortlicher, Datensicherheit nach türkischem DSG. Prof. Dr. Orhan Veli Doğan Website.', ru: 'Обработка персональных данных, сведения о контроллере и безопасность данных по турецкому Закону о персональных данных. Сайт проф. д-ра Орхана Вели Догана.' },
